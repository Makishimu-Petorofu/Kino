...
import com.example.kinosearch.RegisterActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentRegister = new Intent(com.example.kinosearch.LoginActivity.this, RegisterActivity.class);
        ...
        call.enqueue(new Callback<LoginResponses>() {
            ...
            public void onResponse(Call<LoginResponses> call, Response<LoginResponses> response) {
                if (response.isSuccessful()){
                    ...
                    ed.commit();
                    Intent intent = new Intent(com.example.kinosearch.LoginActivity.this, MainActivity.class);
                    startActivity(intent);

                    finish();
                }else{
                    Toast.makeText(com.example.kinosearch.LoginActivity.this, "Error" ,Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<LoginResponses> call, Throwable t) {
                Toast.makeText(com.example.kinosearch.LoginActivity.this, t.getMessage() ,Toast.LENGTH_LONG).show();
            }
        });
    }
}

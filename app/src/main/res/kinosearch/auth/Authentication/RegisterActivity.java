                                    ...
                                    if (TextUtils.isEmpty(et_last_name.getText().toString())){
                                        if (TextUtils.isEmpty(et_mail_reg.getText().toString())){
                                            if (TextUtils.isEmpty(et_pass_reg.getText().toString())){
                                                ...
                                                Toast.makeText(com.example.kinosearch.RegisterActivity.this,"Поле 'pass' пустое!",Toast.LENGTH_LONG).show();
                                            }
                                        }else{
                                            Toast.makeText(com.example.kinosearch.RegisterActivity.this,"Поле 'email' пустое!",Toast.LENGTH_LONG).show();
                                        }
                                    }else{
                                        Toast.makeText(com.example.kinosearch.RegisterActivity.this,"Поле 'last name' пустое!",Toast.LENGTH_LONG).show();
                                    }
                                }else {
                                    Toast.makeText(com.example.kinosearch.RegisterActivity.this,"Поле 'first name' пустое!",Toast.LENGTH_LONG).show();
                                }
                            }else{
                                Toast.makeText(com.example.kinosearch.RegisterActivity.this,"Пароли не совпадают",Toast.LENGTH_LONG).show();
                            }
                        }else{
        ...
        call.enqueue(new Callback<RegisterResponse>() {
            ...
            public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
                if (response.isSuccessful()){
                    Toast.makeText(com.example.kinosearch.RegisterActivity.this, "Successful",Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(com.example.kinosearch.RegisterActivity.this, "Error",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<RegisterResponse> call, Throwable t) {
                Intent intent = new Intent(com.example.kinosearch.RegisterActivity.this, LoginActivity.class);
